# ppt169_researchstudio_reel_paper

- Source: arXiv:2607.04438 v2 (https://arxiv.org/abs/2607.04438); the 33 MB PDF is not bundled — `sources/researchstudio_reel.md` is its converted text and `sources/researchstudio_reel_files/` the extracted figures (large PNGs re-encoded as JPEG)
