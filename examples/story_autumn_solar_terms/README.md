...
- `images/`: slide images compressed for distribution — slices as PNG with alpha at their generated size, generation sheets as JPEG; `image_prompts.json` records every generation request
